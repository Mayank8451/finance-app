...
class DataLoader():
    ...
    def get_train_data(self, seq_len, normalise):
        ...
        Warming: batch method, not generative, make sure you have enough memory
    ...
    def generate_train_batch(self, seq_len, batch_size, normalise):
        """Yield a generator of training data from filename on given list of
        cols split for train/test
        """    
        i = 0
